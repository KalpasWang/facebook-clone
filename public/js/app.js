...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: "bg-white rounded shadow w-11/12 max-w-sm h-16 my-2" },
      [
        _c(
          "div",
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "flex flex-col items-center pt-4 px-6 h-screen overflow-y-hidden"
    },
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "bg-white rounded shadow w-full max-w-sm mt-6" },
    [
      _vm._m(0),
      _vm._v(" "),
      _vm._m(1),
      ...
      _c(
        ...
        [
          _c("div", { staticClass: "flex" }, [
            ...
            _vm._v(" "),
            _c("p", { staticClass: "ml-4" }, [_vm._v("502")])
          ]),
          _vm._v(" "),
          _vm._m(2)
        ]
      ...
      _c(
        "div",
        { staticClass: "flex justify-between border-1 border-gray-400 m-1" },
        [
          _c(
            "button",
            {
