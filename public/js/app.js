...
/* harmony import */ var _components_RoundedButton__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/RoundedButton */ "./resources/js/components/RoundedButton.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    RoundedButton: _components_RoundedButton__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  computed: Object(vuex__WEBPACK_IMPORTED_MODULE_3__["mapGetters"])(['user', 'friendBtnText', 'friendship']),
  methods: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.$store.dispatch('sendFriendRequest', _this.$route.params.userId);
  ...
  mounted: function mounted() {
    ...
    axios.get('/api/users/' + this.$route.params.userId + '/posts').then(function (res) {
      ...
      _this2.postsErrorMsg = 'Unable to fetch posts';
      _this2.postsLoading = false;
    });
  }
});
          ...
          _vm.friendBtnText
            ? _c(
                ...
                [
                  _c("RoundedButton", {
                    key: _vm.btnKey,
                    attrs: { btnText: _vm.friendBtnText },
